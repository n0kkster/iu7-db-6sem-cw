...
% Выравнивание списка по маркеру и полуторный интерва
\setlist[enumerate]{
    label=\arabic*), 
    leftmargin=2cm,
    labelsep=0.3cm,
...
% Картинки, поставленные на бок
\newcommand{\vimg}[2] {
	\begin{figure}[h!]
		\centering
		\includegraphics[angle=90, height=0.8\textheight, keepaspectratio]{img/#1}
		\caption{#2}
		\label{img:#1}
	\end{figure}
}
...
\AtBeginEnvironment{tabularx}{\stepcounter{tables}}
