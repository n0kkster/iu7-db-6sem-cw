set terminal svg standalone enhanced dynamic size 800,400 font 'Arial,16'
set output 'plots/cascade.svg'
...
plot 'plots/cascade_results.csv' using 1:2 with linespoints \
